...
/**
 * @dev Modified contract of the original Angry Pitbull Club contract.
 * 
 * Changes:
 *  - AIRDROP_RESERVE has been changed from 50 to 500.
 *  - MAX_PUBLIC_MINT has been changed from 9950 to 9500.
 *  - airdropAngryPitbulls has been given a `to` address.
 *  - airdropAngryPitbulls returns the id of the last airdropped apc. 
 */ 
...
contract AngryPitbullClub is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // Total supply 10,000
    uint256 public constant MAX_PUBLIC_MINT = 9500;
    ...
    function airdropAngryPitbulls(uint256 _numberOfPitbulls, address to_) external onlyOwner returns (uint256) {
        require(_numberOfPitbulls > 0, "You cannot mint 0 Pitbulls.");
